...
<body style="background: url(&quot;<?php echo $config['beijing']?>&quot;);height:100%!important;">




  <div class="col-xs-12 col-sm-10 col-md-8 col-lg-8 center-block" style="float: none;height:100%;">

 <table class="" style="border:0px; height:100%;">
  <tbody>
	<div class="col-md-14 column" >
    <div class="panel panel-default" style="height: 100%">
    <div id="kj" class="panel-body" style="height: 100%">
    <iframe src="<?php echo $config['zdbf']?>" id="player" width="100%" height="100%" allowfullscreen="true"  allowtransparency="true" frameborder="0" scrolling="no" webkitallowfullscreen="true"
